if (DEFINED RAPIDWRIGHT_PATH)
	...
	set(CMAKE_JAVA_INCLUDE_PATH ${RAPIDWRIGHT_PATH}/src ${RAPIDWRIGHT_PATH}/bin ${RAPIDWRIGHT_JARS} ${GSON_PATH})
	string (REPLACE ";" " \n " RAPIDWRIGHT_JARS_STR "${RAPIDWRIGHT_JARS}")
	set(RAPIDWRIGHT_CLASSPATH "${RAPIDWRIGHT_PATH}/bin/ \n ${RAPIDWRIGHT_JARS_STR}")
	...
	file(APPEND xilinx/java/bbaexport.mf "Class-Path: ${RAPIDWRIGHT_CLASSPATH}\n")
	...
	file(APPEND xilinx/java/json2dcp.mf "Class-Path: ${RAPIDWRIGHT_CLASSPATH} \n ${GSON_PATH}\n")
